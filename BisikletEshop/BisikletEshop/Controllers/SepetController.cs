...
namespace BisikletEshop.Controllers
{
	public class SepetController : Controller
	{
		...
		public IActionResult SepeteUrunEkle(int id)
		{
			...
			Urun? eklenecekUrun = db.Urunler.SingleOrDefault(k => k.UrunId == id);
		...
		public IActionResult SepettenUrunSil(int id)
		{
			...
			string kitapAdi = db.SepetElemanlari.Include(se => se.Urun).SingleOrDefault(se => se.UrunId == id && se.SepetAd == sepetim.SepetAdi).Urun.Ad;
